...
SIMAPP = ./app
HTTPS_GIT := https://github.com/evoblockchain/ethermint.git
...
PACKAGE_NAME:=github.com/evoblockchain/ethermint
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/evoblockchain/ethermint/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/evoblockchain/ethermint/tests/importer
