...
## Use Case: Call Native ERC20 Module on Evoblock

Here is an example taken from the Evoblock [erc20 module](https://evoblock.dev/modules/erc20/) that shows how the `EVMHooks` supports a contract calling a native module to convert ERC-20 Tokens into Cosmos native Coins. Following the steps from above.
