...
The `x/evm` is part of the [ethermint library](https://pkg.go.dev/github.com/evoblockchain/ethermint). For an example of how Ethermint can be used on any Cosmos-SDK chain, please refer to [Evoblock](https://www.github.com/tharsis/evoblock).
