...
var (
	...
	pattern_Query_BaseFee_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"ethermint", "evm", "v1alpha1", "base_fee"}, "", runtime.AssumeColonVerbOpt(true)))
