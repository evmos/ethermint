...
type Params struct {
	...
	RejectUnprotected bool `protobuf:"varint,6,opt,name=reject_unprotected,json=rejectUnprotected,proto3" json:"reject_unprotected,omitempty"`
}
...
func (m *Params) GetRejectUnprotected() bool {
	if m != nil {
...
var fileDescriptor_d21ecc92c8c8583e = []byte{
	...
	,
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RejectUnprotected", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
