...
type Params struct {
	...
	MinGasDenominator uint64 `protobuf:"varint,6,opt,name=min_gas_denominator,json=minGasDenominator,proto3" json:"min_gas_denominator,omitempty" yaml:"min_gas_denominator"`
}
...
func (m *Params) GetMinGasDenominator() uint64 {
	if m != nil {
		return m.MinGasDenominator
	}
	return 0
}
...
var fileDescriptor_d21ecc92c8c8583e = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.MinGasDenominator != 0 {
		i = encodeVarintEvm(dAtA, i, uint64(m.MinGasDenominator))
		i--
		dAtA[i] = 0x30
	}
	{
...
func (m *Params) Size() (n int) {
	...
	n += 1 + l + sovEvm(uint64(l))
	if m.MinGasDenominator != 0 {
		n += 1 + sovEvm(uint64(m.MinGasDenominator))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinGasDenominator", wireType)
			}
			m.MinGasDenominator = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowEvm
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinGasDenominator |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
