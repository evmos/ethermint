...
func init() {
	apiCreators = map[string]APICreator{
		EthNamespace: func(ctx *server.Context,
			...
			return []rpc.API{
				...
				},
				{
					Namespace: EthNamespace,
					Version:   apiVersion,
					Service:   filters.NewPublicAPI(ctx.Logger, clientCtx, evmBackend),
					Public:    true,
				},
			}
		},
		Web3Namespace: func(*server.Context, client.Context, bool, ethermint.EVMTxIndexer) []rpc.API {
			return []rpc.API{
				{
		...
		NetNamespace: func(_ *server.Context, clientCtx client.Context, _ bool, _ ethermint.EVMTxIndexer) []rpc.API {
			return []rpc.API{
				{
		...
		TxPoolNamespace: func(ctx *server.Context, _ client.Context, _ bool, _ ethermint.EVMTxIndexer) []rpc.API {
			return []rpc.API{
				{
