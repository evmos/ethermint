...
func confirmRequestValidationCode(t *testing.T, method, contentType, body string, expectedStatusCode int) {
	...
	code, err := server.ValidateRequest(request)
	if code == 0 {
		if err != nil {
...
func TestHTTPErrorResponseWithDelete(t *testing.T) {
	confirmRequestValidationCode(t, http.MethodDelete, types.ContentType, "", http.StatusMethodNotAllowed)
}

func TestHTTPErrorResponseWithPut(t *testing.T) {
	confirmRequestValidationCode(t, http.MethodPut, types.ContentType, "", http.StatusMethodNotAllowed)
}

func TestHTTPErrorResponseWithMaxContentLength(t *testing.T) {
	body := make([]rune, types.MaxRequestContentLength+1)
	confirmRequestValidationCode(t,
		http.MethodPost, types.ContentType, string(body), http.StatusRequestEntityTooLarge)
}
...
func TestHTTPErrorResponseWithValidRequest(t *testing.T) {
	confirmRequestValidationCode(t, http.MethodPost, types.ContentType, "", 0)
}
...
func TestHTTPRespBodyUnlimited(t *testing.T) {
	const respLength = types.MaxRequestContentLength * 3
