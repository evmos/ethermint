...
// The Ethereum API allows applications to connect to an Evoblock node that is
// part of the Evoblock blockchain. Developers can interact with on-chain EVM data
