...
* (evm) [tharsis#334](https://github.com/tharsis/ethermint/pull/334) Log index changed to the index in block rather than
  tx.
* (evm) [tharsis#399](https://github.com/tharsis/ethermint/pull/399) Exception in sub message call reverts that call if not propagated.
...
* (deps) [tharsis#165](https://github.com/tharsis/ethermint/pull/165), [tharsis#298](https://github.com/tharsis/ethermint/pull/298) Bump Cosmos SDK and Tendermint versions to [v0.43.0-rc3](https://github.com/cosmos/cosmos-sdk/releases/tag/v0.43.0-rc3) and [v0.34.11](https://github.com/tendermint/tendermint/releases/tag/v0.34.11), respectively.
